        ...
        <div className="wrapper">
            ...
            <div className="temWrap">
                <div className="temLeft">
                    <h3>FALAH ALKHAIR Lim <span>Chiropractor (IMU)</span></h3>
                    <p>Graduated from IMU from one of the pioneering chiropractic batches in IMU, FALAH ALKHAIR has over 10 years of experience in providing safe, effective, and non-invasive chiropractic care.  </p>
