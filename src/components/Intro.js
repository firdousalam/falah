  ...
  return (
    <section className="intro">
        <div className="wrapper">
            <p className="text-center smCol">Al Qannaatii-BKC Group of Companies®.</p>
            <div className="sec-wrapper">
                ...
                <div className="sec-Right">
                    ...
                    <p>Al Qannaatii-BKC Group of Companies was established in the year 2002 with its headquarters in Sharjah and subsidiary offices in Dubai and Ajman .Over the years the company has evolved into one of the leading Manpower Supply & Outsourcing Group in the United Arab Emirates. We have been actively involved in various services and were able to meet the man power demands of major construction & contracting companies, industries and refineries.
